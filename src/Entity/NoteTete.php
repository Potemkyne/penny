...
/**
 * @ORM\Entity(repositoryClass="App\Repository\NoteTeteRepository")
 */
class NoteTete
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Parfum", mappedBy="tetefk")
     */
    private $parfums;
