...
/**
 * @ORM\Entity(repositoryClass="App\Repository\NoteFondRepository")
 */
class NoteFond
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Parfum", mappedBy="fondfk")
     */
    private $parfums;
